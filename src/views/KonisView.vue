  ...
  methods: {
    async submitData() {
      try {
        ...
        this.fetchData();
        this.resetForm();
        this.$refs.closeModalButton.click(); // Klik tombol tutup modal menggunakan ref
      } catch (error) {
    ...
    exportToExcel() {
      const worksheet = XLSX.utils.json_to_sheet(this.konisData);
      const workbook = XLSX.utils.book_new();
      XLSX.utils.book_append_sheet(workbook, worksheet, "Konis Data");
      const excelBuffer = XLSX.write(workbook, {
        bookType: "xlsx",
        type: "array",
      });
      this.saveAsExcelFile(excelBuffer, "konis-data");
    },
