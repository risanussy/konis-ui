...
export default {
  ...
  methods: {
    ...
    exportToExcel() {
      const worksheet = XLSX.utils.json_to_sheet(this.peminjamanData);
      const workbook = XLSX.utils.book_new();
      XLSX.utils.book_append_sheet(workbook, worksheet, "peminjaman Data");
      const excelBuffer = XLSX.write(workbook, {
        bookType: "xlsx",
        type: "array",
      });
      this.saveAsExcelFile(excelBuffer, "peminjaman-data");
    },
